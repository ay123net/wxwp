...
var DOMAIN = "zsss.ay123.net";
var MINAPPTYPE="0";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="掌上深汕"; //网站名称
...
var PAYTEMPPLATEID = 'CjwRniCdLWfaqTxRqxHUI-vN49105Icyq-YKcG8o9Rs';//赞赏消息模版id
var REPLAYTEMPPLATEID = 'mWd-bFWq2VoT_rT0EFjECI6LmXkawNktDbhqDzPkjBM';//回复评论消息模版id
...
var DOWNLOADFILEDOMAIN = [
  { id: 1, domain: 'zsss.ay123.net' },
  { id: 2, domain: 'zsss.ay123.net' },
  { id: 3, domain: 'zsss.ay123.net' }
]
 //首页图标导航
...
var INDEXNAV = [
    ...
    { id: '3', name: '公众号', image: '../../images/app.png', url: '../list/list?categoryID=98', redirecttype: 'apppage', appid: '', extraData: '' },
   ]
